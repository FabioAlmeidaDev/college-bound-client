<template>
  <v-container class="view-athlete">
    <v-row> 
      ...
      <v-row class="section">
        <v-col sm="12">
          <h3 class="section-header"><span class="athlete-number">{{athlete_number}}</span>{{name}}</h3>
          <h4>{{clubname}}</h4>
        </v-col>
        <v-col md="6" sm="12">
        ...
        <v-col md="6" sm="12">
          ...
          <div class="view-athlete-value"><a :href="youtube" target="_blank">{{youtube}}</a></div>
          
          <div class="view-athlete-label">Instagram URL</div>
          <div class="view-athlete-value"><a :href="instagram" target="_blank">{{instagram}}</a></div>
